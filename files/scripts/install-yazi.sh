...
# yazi is not in Fedora repos; we use the pre-built gnu binary for proper statx (btime) support.
set -euo pipefail
...
TARBALL="yazi-${ARCH}-unknown-linux-gnu.zip"
...
EXTRACTED="yazi-${ARCH}-unknown-linux-gnu"
